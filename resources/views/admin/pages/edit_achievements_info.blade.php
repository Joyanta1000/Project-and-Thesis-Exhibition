      ...
      <div class="adminx-content">
        <div class="adminx-main-content">
          <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-lg-6">
                <form action="/update_achievements_information/{{$achievements_info->id}}" method="POST">
                  <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
                <div class="card mb-grid">
                  <div class="card-header">
                    <div class="card-header-title">Update Achievement</div>
                  </div>
...
@endif
                  ...
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input class="form-control mb-2" name="name" type="text" value="{{ $achievements_info->name }}">
                    </div>
