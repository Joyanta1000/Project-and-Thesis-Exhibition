                    ...
                    <table class="table table-actions table-striped table-hover mb-0" data-table>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          @endif
                          <td>
                            <a type="button" class="btn btn-primary" href="{{URL::to('/edit_type/'.$type->id)}}">Edit</a>
                          <a type="button" class="btn btn-danger" href="{{URL::to('delete_types_information/'.$type->id)}}" onclick="return confirm('Are you sure to delete?')" >Delete</a>
                          </td>
                        </tr>
                        @endforeach
                      </tbody>
