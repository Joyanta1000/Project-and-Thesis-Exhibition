                    ...
                    <table class="table table-actions table-striped table-hover mb-0" data-table>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          @if($role->is_active==1)
                          <td>
                            <a class="badge badge-pill badge-primary"  href="{{URL::to('update_status_of_role/'.$role->id)}}">Active</a>
                            <!-- <button >Active</button> -->
                          </td>
                          @endif
                          @if($role->is_active==0)
                          <td>
                            <a class="badge badge-pill badge-danger" href="{{URL::to('update_status_of_role/'.$role->id)}}">Inactive</a>
                            <!-- <button class="badge badge-pill badge-danger">Inactive</button> -->
                          </td>
                          @endif
                          <td>
                            <a type="button" class="btn btn-primary" href="{{URL::to('/edit_roles_info/'.$role->id)}}">Edit</a>
                          <a type="button" class="btn btn-danger" href="{{URL::to('delete_roles_information/'.$role->id)}}" onclick="return confirm('Are you sure to delete?')" >Delete</a>
                          </td>
                        </tr>
                        @endforeach
                      </tbody>
