                    ...
                    <table class="table table-actions table-striped table-hover mb-0" data-table>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <a class="badge badge-pill badge-primary"  href="{{URL::to('update_status_of_department/'.$department->id)}}">Active</a>
                            <!-- <button >Active</button> -->
                          </td>
                          @endif
                          @if($department->is_active==0)
                          <td>
                            <a class="badge badge-pill badge-danger" href="{{URL::to('update_status_of_department/'.$department->id)}}">Inactive</a>
                            <!-- <button class="badge badge-pill badge-danger">Inactive</button> -->
                          </td>
                          @endif
                          <td>
                            <a type="button" class="btn btn-primary" href="{{URL::to('/edit_departments_info/'.$department->id)}}">Edit</a>
                          <a type="button" class="btn btn-danger" href="{{URL::to('delete_departments_information/'.$department->id)}}" onclick="return confirm('Are you sure to delete?')" >Delete</a>
                          </td>
                        </tr>
                        @endforeach
                      </tbody>
