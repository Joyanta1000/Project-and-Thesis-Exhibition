                    ...
                    <table class="table table-actions table-striped table-hover mb-0" data-table>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <a type="button" class="btn btn-primary" href="{{URL::to('/edit_achievements_info/'.$achievement->id)}}">Edit</a>
                          <a type="button" class="btn btn-danger" href="{{URL::to('delete_achievements_information/'.$achievement->id)}}" onclick="return confirm('Are you sure to delete?')" >Delete</a>
                          </td>
                        </tr>
                        @endforeach
                      </tbody>
