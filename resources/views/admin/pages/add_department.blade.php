      ...
      <div class="adminx-content">
        <div class="adminx-main-content">
          <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-lg-6">
                <form action="/insert_departments_information" method="POST">
                  <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
                <div class="card mb-grid">
                  <div class="card-header">
                    <div class="card-header-title">Add Department</div>
                  </div>
...
@endif
                  ...
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input class="form-control mb-2" name="name" type="text" value="{{old('name')}}" placeholder="Add Departments Name">
                    </div>
