                    ...
                    <table class="table table-actions table-striped table-hover mb-0" data-table>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href="{{ url($university->slug) }}">{{ url($university->slug) }}</a></td>
                          @if($university->is_active==1)
                          <td>
                            <a class="badge badge-pill badge-primary"  href="{{URL::to('update_status_of_university/'.$university->id)}}">Active</a>
                            <!-- <button >Active</button> -->
                          </td>
                          @endif
                          @if($university->is_active==0)
                          <td>
                            <a class="badge badge-pill badge-danger" href="{{URL::to('update_status_of_university/'.$university->id)}}">Inactive</a>
                            <!-- <button class="badge badge-pill badge-danger">Inactive</button> -->
                          </td>
                          @endif
                          <td>
                            <a type="button" class="btn btn-primary" href="{{URL::to('/edit_university/'.$university->id)}}">Edit</a>
                          <a type="button" class="btn btn-danger" href="{{URL::to('delete_universities_information/'.$university->id)}}" onclick="return confirm('Are you sure to delete?')" >Delete</a>
                          </td>
                        </tr>
                        @endforeach
                      </tbody>
