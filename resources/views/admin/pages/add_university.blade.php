      ...
      <div class="adminx-content">
        <div class="adminx-main-content">
          <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-lg-6">
                <form action="/insert_university" method="POST">
                  <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
                <div class="card mb-grid">
                  <div class="card-header">
                    <div class="card-header-title">Add University</div>
                  </div>
...
@endif
                  ...
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input class="form-control mb-2" name="name" type="text" value="{{old('name')}}" placeholder="Add Name">
                    </div>

                    <div class="form-group">
                      <label class="form-label">Email</label>
                      <input class="form-control mb-2" name="email" type="text" value="{{old('email')}}" placeholder="Add Email">
                    </div>

                    <div class="form-group">
                      <label class="form-label">Phone</label>
                      <input class="form-control mb-2" name="phone" type="text" value="{{old('phone')}}" placeholder="Add Phone Number">
                    </div>
